...
<div class="position-relative" style="min-height: 100vh; overflow: hidden;">
    ...
    <!-- Botón volver a home -->
    <a href="{{ route('home.index') }}" class="position-absolute top-0 start-0 m-4 text-primary fs-3 z-2">
                    ...
                    <div class="card text-white {{ $bg }} shadow fade-slide-in">
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ route('auth.register') }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="typeSelect" name="type">
                                        ...
                                        {{-- Puedes habilitar más opciones según sea necesario --}}
                                        {{-- 
                            ...
                            <div class="mt-3 text-center">
                                ¿Ya tienes cuenta? 
                                <a class="text-white fw-bold" href="{{ route('auth.login', ['type' => $type]) }}">
                                    Inicia sesión
                                </a>
                            </div>
                        </div>
